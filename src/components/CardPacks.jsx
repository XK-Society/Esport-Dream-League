      ...
      <div className="flex justify-center gap-6">
        ...
        <div className="w-56 group relative">
          <div className="bg-white rounded-xl shadow-md p-4 h-full flex flex-col">
            ...
            <div className="text-center mb-2">
              <p className="text-xl font-bold text-blue-600">{basicPack.price} LYT</p>
              <p className="text-xs text-gray-600 mb-2">{basicPack.description}</p>
            </div>

            {/* Contents */}
            <div className="bg-gray-50 rounded-lg p-2 mb-3 flex-grow">
        ...
        <div className="w-56 group relative">
          <div className="absolute -top-2 right-2 z-10">
            <span className="bg-gradient-to-r from-purple-600 to-pink-600 text-white px-2 py-0.5 rounded-full text-xs font-bold shadow-lg">
              BEST VALUE
            </span>
          </div>

          <div className="bg-white rounded-xl shadow-md p-4 h-full flex flex-col border border-purple-300">
            {/* Pack Design */}
            ...
            {/* Pack Info */}
            <div className="text-center mb-2">
              <p className="text-xl font-bold text-purple-600">{premiumPack.price} LYT</p>
              <p className="text-xs text-gray-600 mb-2">{premiumPack.description}</p>
            </div>
